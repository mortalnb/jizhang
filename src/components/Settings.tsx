  ...
  return (
    <div className="w-full max-w-md mx-auto p-4 space-y-6 animate-slide-up pb-24">
      ...
      <section className="space-y-1">
        ...
        <p className="text-xs text-dark-muted">管理 AI 接口、分类和月度预算。数据仍保存在本机。</p>
      </section>
      ...
      <form onSubmit={save} className="space-y-5">
        ...
        <div className="flex flex-col gap-3">
          <button type="submit" className="w-full py-3 bg-gradient-to-r from-brand-purple to-brand-blue text-white font-bold rounded-xl shadow-md shadow-brand-purple/20 flex items-center justify-center gap-2 transition-all">
            <Save size={18} />
            保存当前设置
          </button>
